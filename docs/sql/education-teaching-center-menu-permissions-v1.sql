...
VALUES
    ('教学中心', '/portal/education/teaching-center', 14, 'education:teaching', '教学中心', 'ROOT'),
    ('教学计划', '/portal/education/teaching-center', 1, 'education:teaching:plan', '教学计划', 'CRUD'),
    ('教案管理', '/portal/education/teaching-center', 2, 'education:teaching:lesson-plan', '教案', 'CRUD'),
    ('备课管理', '/portal/education/teaching-center', 3, 'education:teaching:preparation', '备课', 'CRUD'),
    ('课件管理', '/portal/education/teaching-center', 4, 'education:teaching:courseware', '课件', 'CRUD'),
    ('教学材料', '/portal/education/teaching-center', 5, 'education:teaching:material', '教学材料', 'CRUD'),
    ('作业管理', '/portal/education/teaching-center', 6, 'education:teaching:homework', '作业入口', 'CRUD'),
    ('题库维护', '/portal/education/teaching-center', 7, 'education:teaching:question-bank', '题库', 'CRUD_IMPORT'),
    ('知识点维护', '/portal/education/teaching-center', 8, 'education:teaching:knowledge-point', '知识点', 'CRUD_IMPORT'),
    ('错题维护', '/portal/education/teaching-center', 9, 'education:teaching:error-book', '错题', 'CRUD'),
    ('教研管理', '/portal/education/teaching-center', 10, 'education:teaching:research', '教研', 'CRUD');
