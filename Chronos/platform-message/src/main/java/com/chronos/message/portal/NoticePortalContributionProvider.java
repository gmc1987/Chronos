...
@Component
public class NoticePortalContributionProvider implements PortalContributionProvider {
	private final IPublicationService service;

	public NoticePortalContributionProvider(IPublicationService service) {
	...
	public PortalContribution load(String username) {
		var values = service.visible(username, "NOTICE", null, false, PageRequest.of(0, 6));
		...
		data.put("allRoute", "/portal/publications?type=NOTICE");
