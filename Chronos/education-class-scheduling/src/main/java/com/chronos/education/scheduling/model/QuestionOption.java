...
public class QuestionOption {
 ...
 @Column(name="option_key",nullable=false,length=8) private String optionKey;
 @Column(name="option_text",nullable=false,columnDefinition="text") private String optionText;
