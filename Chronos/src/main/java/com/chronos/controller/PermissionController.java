...
public class PermissionController {
	...
	public ResultData<PermissionVO> getById(@PathVariable("id") String id) {
		...
		if (vo == null)
			return ResultData.<PermissionVO>builder().code("404").msg("not found").data(null).build();
		return ResultData.<PermissionVO>builder().code("200").msg("success").data(vo).build();
	}
