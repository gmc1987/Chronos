   ...
   implements IPermissionService
 {
   ...
   public PermissionVO getPermissionById(String id) {
     ...
     PermissionVO vo = PermissionVO.builder().id(p.getId()).permissionName(p.getPermissionName()).permissionCode(p.getPermissionCode()).description(p.getDescription()).build();
     return vo;
   }
