...
CREATE INDEX IF NOT EXISTS idx_data_snapshot_date
    ON data_metric_snapshot(snapshot_date, metric_code);
CREATE INDEX IF NOT EXISTS idx_data_quality_issue_status
    ON data_quality_issue(status, due_date);
