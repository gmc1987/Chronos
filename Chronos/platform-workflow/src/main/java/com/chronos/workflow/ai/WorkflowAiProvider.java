...
/**
 * Extension point for an on-premise/private AI model. Implementations must
...
public interface WorkflowAiProvider {
	...
	record AiFinding(String nodeId, String severity, String category, String title, String description,
			String suggestion) {
	}
}
