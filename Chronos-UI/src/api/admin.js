...
export const getScoreClassAnalysisCapability = () => http.get('/admin/education/grades/analysis/class')
export const getScoreGradeAnalysisCapability = () => http.get('/admin/education/grades/analysis/grade')
