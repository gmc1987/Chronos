<template><TeachingDomainPage title="知识点" description="维护知识点层级、描述和关联课程" entity-label="知识点" resource-type="KNOWLEDGE_POINT" :columns="columns" :fields="fields" :defaults="{ name: '', level: '', description: '', course: '' }" /></template>
<script setup>
