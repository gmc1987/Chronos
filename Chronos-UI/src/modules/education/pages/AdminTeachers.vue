...
const columns = [{ prop: 'teacherNo', label: '教师编号' }, { prop: 'teacherName', label: '姓名' }, { prop: 'specialty', label: '专业方向' }, { prop: 'accountUsername', label: '绑定账号' }, { prop: 'accountStatus', label: '账号状态' }, { prop: 'maxWeeklyLessons', label: '周课时上限' }]
