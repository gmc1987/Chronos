  ...
  routes: [
    ...
    { path: '/account/change-password', name: 'change-password', component: ChangePassword },
    {
      ...
      children: [
        ...
        { path: 'education/preparation', redirect: { name: 'admin-education-preparation' } },
        ...
        { path: 'education/teaching-center/knowledge-points', redirect: { name: 'admin-education-knowledge-point' } },
        { path: 'education/knowledge-points', redirect: { name: 'admin-education-knowledge-point' } },
        ...
        { path: 'education/teaching-center/mistakes', redirect: { name: 'admin-education-error-book' } },
        { path: 'education/teaching-center/research', name: 'admin-education-research', component: AdminResearch },
        { path: 'education/research', redirect: { name: 'admin-education-research' } },
